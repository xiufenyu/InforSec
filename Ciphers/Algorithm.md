...
|-----------------------------------|---------------------------------------------------------|
| RSA                               | Used for digital signatures and "wrapping" AES keys.    |
| ECC (Elliptic Curve Cryptography) | Used in Bitcoin, WhatsApp, and TLS 1.3.                 |
| Diffie-Hellman (DH)               | Key Exchange (creating a shared key over an open line). |
